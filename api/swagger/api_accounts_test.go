...
func TestGetDevicesSuccess(t *testing.T) {
	...
	shdw.EXPECT().Get(gomock.Eq("63eda5eb-7f56-417f-88ed-44a9eb9e5f67")).Return(shadow.Shadow{
		Timestamp: createTime(t, "2020/03/22 00:27:00"),
		State:     {Reported: map[string]interface{}{"status": true}},
		Metadata:  {Reported: map[string]MetadataEntry{"status": {Timestamp: createTime(t, "2020/03/22 01:27:00")}}},
	})
